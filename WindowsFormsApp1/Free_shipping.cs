...
{
    public partial class Free_shipping : Form
    {
        ...
        {
            label4.Text = "消费满               (件)包邮:";
            def_type = 2;
        }

        private void radioButton1_CheckedChanged(object sender, EventArgs e)
        {
            label4.Text = "消费满               (元)包邮:";
            def_type = 1;
        }

        private void button1_Click(object sender, EventArgs e)
        {
            string post_url = "https://www.zhengdianzisha.com/zhibo/store/create-full" + "?jwt=" + jwt_str;

            //定义post内容
            string post_str = "type=" + def_type.ToString() +
                              "&name=" + textBox1.Text +
                              "&child[0][province]=" + richTextBox1.Text +
                              "&child[0][num]=" + textBox2.Text;
        ...
        private void Free_shipping_Load(object sender, EventArgs e)
        {
